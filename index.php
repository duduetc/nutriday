...
<html lang="pt-BR">
  <head>
    ...
    <meta
      name="description"
      content="NUTRIDAY — nutrição clínica, nutrigenética e cuidado individual em Brasília."
    />
  ...
  <body
    class="__variable_geist_0u6v6a2 __variable_geist_mono_0r2upu1 antialiased"
  >
    <main>
      ...
      <header class="site-header shell">
        ...
        <nav class="desktop-nav" aria-label="Navegação principal">
          <a href="#metodo">A NUTRIDAY</a><a href="#profissional">Quem sou</a
          ><a href="#testes">Testes</a><a href="#jornada">Como funciona</a
          ><a href="#contato">Contato</a>
        </nav>
        <a class="header-login" href="#contato"
          >Falar com a clínica <span>↗</span></a
        >
      </header>
      <section class="hero shell" id="inicio">
        <div class="hero-copy">
          ...
          <div class="hero-actions">
            <a class="btn-primary" href="#contato"
              >Quero conhecer a NUTRIDAY <span>→</span></a
            ><a class="text-link" href="#testes"
              >Conhecer os testes <span>↗</span></a
            >
          </div>
        ...
        <div
          class="hero-visual"
          aria-label="Composição editorial de alimentos naturais"
        >
          <div class="hero-frame">
            <img
              src="/hero-natriday.webp"
              alt="Composição elegante com alimentos frescos e elementos naturais"
              loading="eager"
              fetchpriority="high"
              decoding="async"
      ...
      <section class="manifesto shell motion-reveal" id="metodo">
        ...
        <div class="manifesto-grid">
          ...
          <div>
            ...
            <a href="#jornada" class="under-link"
              >Conheça nossa abordagem <span>→</span></a
            >
          </div>
        </div>
      </section>
      <section class="doctor shell motion-reveal" id="profissional">
        <div class="doctor-photo">
          <img
            src="/doutora-natriday-hq.webp"
            alt="Nutricionista da NUTRIDAY em seu consultório"
            loading="lazy"
            decoding="async"
            sizes="(max-width: 900px) 100vw, 48vw"
            style="
        ...
        <div class="tests-grid">
          <article class="test-card">
            <div class="test-image">
              <img
                src="/hipersensibilidade-alimentar.webp"
                alt="Alimentos naturais apresentados em uma avaliação clínica"
                loading="lazy"
                decoding="async"
            ...
            <div class="test-content">
              ...
              <a class="test-cta" href="https://wa.me/5561996748315?text=Ol%C3%A1%2C%20quero%20saber%20mais%20sobre%20a%20avalia%C3%A7%C3%A3o%20de%20hipersensibilidade%20alimentar." target="_blank" rel="noreferrer"
                >Quero saber mais <span>→</span></a
              >
              <p class="test-phrase">
          ...
          <article class="test-card">
            <div class="test-image">
              <img
                src="/teste-nutrigenetico.webp"
                alt="Representação de DNA associada à nutrição personalizada"
                loading="lazy"
                decoding="async"
                sizes="(max-width: 900px) 100vw, 33vw"
                style="
            ...
            <div class="test-content">
              ...
              <a class="test-cta" href="https://wa.me/5561996748315?text=Ol%C3%A1%2C%20quero%20saber%20mais%20sobre%20o%20teste%20nutrigen%C3%A9tico." target="_blank" rel="noreferrer"
                >Quero saber mais <span>→</span></a
              >
              <p class="test-phrase">
          ...
          <article class="test-card">
            <div class="test-image">
              <img
                src="/teste-microbiota-intestinal.webp"
                alt="Ilustração científica delicada da microbiota intestinal"
                loading="lazy"
                decoding="async"
                sizes="(max-width: 900px) 100vw, 33vw"
                style="
            ...
            <div class="test-content">
              ...
              <a class="test-cta" href="https://wa.me/5561996748315?text=Ol%C3%A1%2C%20quero%20saber%20mais%20sobre%20o%20teste%20de%20microbiota%20intestinal." target="_blank" rel="noreferrer"
                >Quero saber mais <span>→</span></a
              >
              <p class="test-phrase">
      ...
      <section class="testimonials motion-reveal" id="depoimentos">
        ...
        <div
          class="shell testimonials-grid"
          aria-label="Depoimentos de pacientes"
        >
          <article class="testimonial-card testimonial-1">
            <div class="testimonial-photo">
              <img
                src="/depoimento-eduarda.webp"
                alt="Registro do depoimento de Eduarda Gondim"
                loading="lazy"
                decoding="async"
          ...
          <article class="testimonial-card testimonial-2">
            <div class="testimonial-photo">
              <img
                src="/depoimento-renata.webp"
                alt="Registro do depoimento de Renata Correia"
                loading="lazy"
                decoding="async"
                sizes="(max-width: 900px) 80vw, 26vw"
                style="
          ...
          <article class="testimonial-card testimonial-3">
            <div class="testimonial-photo">
              <img
                src="/depoimento-mensagem.webp"
                alt="Registro do depoimento de Paciente NUTRIDAY"
                loading="lazy"
                decoding="async"
                sizes="(max-width: 900px) 80vw, 26vw"
                style="
            ...
            <div class="testimonial-copy">
              ...
              <div class="testimonial-person">
                <strong>Paciente NUTRIDAY</strong
                ><small>Mensagem real recebida</small>
              </div>
            </div>
          </article>
          <article class="testimonial-card testimonial-4">
            <div class="testimonial-photo">
              <img
                src="/depoimento-fabiana.webp"
                alt="Registro do depoimento de Fabiana Martins"
                loading="lazy"
                decoding="async"
                sizes="(max-width: 900px) 80vw, 26vw"
                style="
            ...
            <div class="testimonial-copy">
              ...
              <div class="testimonial-person">
                <strong>Fabiana Martins</strong
                ><small>Paciente NUTRIDAY desde 2015</small>
              </div>
            </div>
          </article>
        </div>
        ...
        <div class="contact-card">
          <div class="contact-main">
            ...
            <div class="contact-actions">
              <a
                class="btn-primary whatsapp-button"
                href="https://wa.me/5561996748315"
                target="_blank"
                rel="noreferrer"
                >Falar no WhatsApp <span>→</span></a
              ><span class="contact-note">(61) 99674-8315</span>
              <a
                class="contact-instagram"
                href="https://www.instagram.com/nutridayannarosa_/"
                target="_blank"
                rel="noreferrer"
                aria-label="Abrir o Instagram da NUTRIDAY"
                >Instagram <strong>@nutridayannarosa_</strong> <span>↗</span></a
              >
            </div>
          </div>
          <div class="clinic-info">
            ...
            <div class="clinic-address">
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer"
                >Ver localização no Google Maps <span>↗</span></a
              >
            </div>
          </div>
        </div>
        ...
        <div class="shell footer-grid">
          <div class="footer-brand">
            <a
              ...
              aria-label="NUTRIDAY - início"
              ><span>N</span><strong>NUTRIDAY</strong></a
            >
            <p>Nutrição Clínica e Genética</p>
            <em>Cuidar de você é o que me move.</em>
          </div>
          <div>
            <small>Explorar</small><a href="#profissional">Quem sou</a
            ><a href="#testes">Testes</a><a href="#depoimentos">Depoimentos</a
            ><a href="#jornada">Como funciona</a><a href="#contato">Contato</a>
          </div>
          <div class="footer-contact">
            ...
            ><a
              ...
              target="_blank"
              rel="noreferrer"
              ><b>WhatsApp</b><span>(61) 99674-8315</span></a
            ><span
              >Ed. Central Park · sala 1909<br />Asa Norte · Brasília, DF</span
            ><a
            ...
            ><a
              ...
              target="_blank"
              rel="noreferrer"
              >Como chegar <span>↗</span></a
            >
          </div>
        </div>
        <div class="shell footer-bottom">
          <span>© 2026 NUTRIDAY</span
          ><span>Nutrição clínica, genética e cuidado individual.</span>
